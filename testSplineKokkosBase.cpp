...
int main(int argc, char* argv[]) {
	...
	//Sticking to just cuda space or host space for now
		...
		std::cout << "Number of ctrlPts: " << ex1.getNumCtrlPts() << std::endl;
		std::cout << "Number of knots: " << ex1.getNumKnots() << std::endl;
		std::cout << "Number of weights: " << ex1.getWeightSize() << std::endl; 
